...
namespace GEE_Web.Areas.Admin.Controllers
{
    public class ClassMasterController : BaseController
    {
        ...
        ClassMasterService service = new ClassMasterService();
        ...
        {            
            ClassMasterGridViewModel collection = new ClassMasterGridViewModel();
            ...
            var list = await service.GetAllClassMasterData(stringContent);
            if (list.Count > 0)
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<JsonResult> Create(ClassMasterViewModel collection)
        {
            try
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult> Edit(ClassMasterViewModel collection)
        {
            try
            {
                collection.ModifiedDate = DateTime.Now;
