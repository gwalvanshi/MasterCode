    ...
    if (isAllValid) {
        try {
            var data = {
                ...
                City_ID: $('#GEE1010mdCity_ID').val() == undefined ? 0 : $('#GEE1010mdCity_ID').val().trim(),
                ...
                Country_ID: $('#GEE1010mdCountry_ID').val() == undefined ? 0 : $('#GEE1010mdCountry_ID').val().trim(),
...
$(document).ready(function () {
    ...
    $.getScript(combojsURL, function myfunction() {
        var CandidateId = $('#CandidateId').val() == undefined ? "" : $('#CandidateId').val();
        if (CandidateId != "")
...
function GetCandidateDetails(PKID) {
...
function BindEdit() {
    ...
    LoadCombo('GEE1010mdEnquiry_ID', 'Enquiry', 'EnquiryNo', 'Enquiry_ID', 'ISDeleted=0 AND EnquiryNo IS NOT NULL', CandidatesDetails.Enquiry_ID);
